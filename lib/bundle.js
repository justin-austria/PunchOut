...
class LittleMac{
  constructor(img, x, y, w, h){
    ...
    this.spriteAnimations = {
      ...
      leftJab: {
        frames: [new __WEBPACK_IMPORTED_MODULE_0__sprite__["a" /* default */](img, 30, 480, 72, 161), new __WEBPACK_IMPORTED_MODULE_0__sprite__["a" /* default */](img, 100, 480, 72, 161),
                 new __WEBPACK_IMPORTED_MODULE_0__sprite__["a" /* default */](img, 170, 480, 72, 161)],
        currentFrame: 0
      },
      ...
      leftJab: {
        animation: (data) => {
          if (data.entityFrame.littleMac % 5 === 0) {
            this.sprite = (this.spriteAnimations.leftJab.frames)[this.spriteAnimations.leftJab.currentFrame];
