...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__render__ = __webpack_require__(8);
...
class Game {
  ...
  intro() {
    ...
    this.data.canvas.ctxTop.fillText("Get ready!",200,160);
    let counter = 3;
    let countdown = setInterval(() => {
      ...
      if (counter === 0) {
        counter = "Fight!";
        this.data.canvas.ctxTop.clearRect(0,0,500,300);
        this.data.canvas.ctxTop.fillText(`${counter}`,200,160);
        return false;
      }
      this.data.canvas.ctxTop.clearRect(0,0,500,300);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__entities_ref_mario__ = __webpack_require__(7);
