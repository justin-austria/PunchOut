...
class Game {
  constructor(canvas) {
    ...
    this.bgm = fightTheme;
    this.input = new __WEBPACK_IMPORTED_MODULE_3__input__["a" /* default */]();
...
class Display {
  constructor(data) {
    ...
    const littleMac = new __WEBPACK_IMPORTED_MODULE_1__entities_little_mac__["a" /* default */](data.macSpriteSheet, 320, 300, 67, 161);
...
class LittleMac{
  constructor(img, x, y, w, h){
    this.sprite = new __WEBPACK_IMPORTED_MODULE_0__sprite__["a" /* default */](img, 28, 10, 67, 161);
    this.x = x;
    this.y = y;
    this.w = w;
    this.h = h;
    ...
    this.spriteAnimations = {
      idle : {
        frames: [new __WEBPACK_IMPORTED_MODULE_0__sprite__["a" /* default */](img, 28, 10, 67, 161), new __WEBPACK_IMPORTED_MODULE_0__sprite__["a" /* default */](img, 98, 10, 67, 161)],
        currentFrame: 0
      },

      leftJab: {
        frames: [new __WEBPACK_IMPORTED_MODULE_0__sprite__["a" /* default */](img, 30, 480, 67, 161), new __WEBPACK_IMPORTED_MODULE_0__sprite__["a" /* default */](img, 100, 480, 67, 161),
                 new __WEBPACK_IMPORTED_MODULE_0__sprite__["a" /* default */](img, 170, 480, 67, 161)],
        currentFrame: 0
      },
      ...
      leftDodge: {
        frames: [new __WEBPACK_IMPORTED_MODULE_0__sprite__["a" /* default */](img, 26, 160, 67, 161), new __WEBPACK_IMPORTED_MODULE_0__sprite__["a" /* default */](img, 96, 160, 67, 161),
                 new __WEBPACK_IMPORTED_MODULE_0__sprite__["a" /* default */](img, 166, 160, 67, 161)],
        currentFrame: 0
      },
      ...
      leftDodge:{
        animation: (data) => {
          if (data.entityFrame.littleMac % 5 === 0) {
            ...
            if (this.spriteAnimations.leftDodge.currentFrame >= 3) {
