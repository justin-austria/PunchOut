...
class Game {
  ...
  play() {
    ...
    const loop = () => {
      ...
      if (this.data.entityFrame.glassJoe > 50 && this.data.entityFrame.glassJoe < 100) {
        this.data.glassJoe.prep();
      }

      if (this.data.entityFrame.glassJoe > 100) {
        this.data.glassJoe.punch();
      }

      if (this.data.entityFrame.glassJoe === 150) {
        this.data.glassJoe.reidle();
        this.data.entityFrame.glassJoe = 0;
      }


      console.log(this.data.glassJoe.currentState);
...
class GlassJoe{
  constructor(img, x, y, w, h){
    ...
    this.spriteAnimations = {
      ...
      punchFire: {
        frame: new __WEBPACK_IMPORTED_MODULE_0__sprite__["a" /* default */](img, 219, 476, 80, 220),
        currentFrame: 0
      }
